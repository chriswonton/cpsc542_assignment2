...
img_path = "/app/rundir/cpsc542_assignment2/butterfly_dataset/images/0070044.png"
...
plt.savefig("visualizations/unet/gradCAM/heatmap.png")

# Superimposed Visualization
def save_and_display_gradcam(img_path, heatmap, cam_path="visualizations/unet/gradCAM/superVis.png", alpha=0.4):
